...
public class CrystaliteArmorRenderer extends HumanoidArmorRenderer {
    private final static ResourceLocation FIRST_LAYER = BetterEnd.makeID(
            "textures/models/armor/crystalite_layer_1.png");
    private final static ResourceLocation SECOND_LAYER = BetterEnd.makeID(
    ...
    protected HumanoidModel<LivingEntity> getModelForSlot(LivingEntity entity, EquipmentSlot slot) {
        ...
        if (slot == EquipmentSlot.CHEST) {
            if (entity instanceof AbstractClientPlayer acp && "slim".equals(acp.getModelName())) {
